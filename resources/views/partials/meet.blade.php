...
<div class="row meet-container">
  <div class="meet-header-container small-12 small-centered medium-12 columns">
    <h1>meet the adelie team</h1>
    <h2>Introducing the people behind the name.</h2>
  </div>
  <!-- Kevin -->
  <div class="kevin team-member small-12 medium-6 large-5 columns boxed">
    <img src="../img/ko_bw.JPG" alt="kevin">
    <h2>kevin</h2>
    <h4>web developer</h4>
    <hr>
    <p>A tinkering programmer for eight years, and a web developer for six.</p>
